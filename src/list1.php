...
?>
    ...
    <div class="container mt-4 mb-4" style="background-color: white;">

      <div class="row mb-5" style="background-color: #e48342;">
        <h3 style="text-align: center;" class="py-3 rounded-3">Wishlist</h3>
            ...
            <div class="row mb-3">
              <div class="col-2">
                ...
                <div class="edit" style="margin-left:65%; margin-top: 7px;">
              ...
              <div class="col-2">
                <div class="edit" style="margin-left: 20%; margin-top: 7px;">
