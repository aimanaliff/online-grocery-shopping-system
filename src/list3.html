...
<body>
  ...
  <body>
    <header class="py-3" style="background-color: #92D050;">
      <div class="container d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 5fr;">
        ...
        <div class="d-flex align-items-center">
          <div class="input-group">
            ...
            <button class="btn btn-success" type="button" id="button-addon2" style="border-radius: 0 20px 20px 0;"><span
          ...
          <ul class="navbar-nav ms-3 mb-2 mb-md-0 d-flex flex-row">
            <li class="nav-item mx-1">
              <a href="user.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                  height="25" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                </svg></a>
            </li>
            <li class="nav-item mx-1">
              <a href="list1.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="23"
                  height="23" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
                  <path fill-rule="evenodd"
                    d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                </svg></a>
            </li>
            <li class="nav-item mx-1">
              <a href="cart.html" class="nav-link text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                  height="25" fill="currentColor" class="bi bi-basket2-fill" viewBox="0 0 16 16">
                  <path
        ...
        <div class="modal-content">
          ...
          <div class="modal-body signin_modal">
            <ul class="nav nav-tabs tab" id="myTab" role="tablist">
              <li class="nav-item1">
                <a class="nav-link " id="home-tab" data-bs-toggle="tab" data-bs-target="#signin" href="#signin"
                  type="button" role="tab" aria-controls="home" aria-selected="true">Sign In</a>
              </li>
              <li class="nav-item1" role="presentation">
                <a class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#signup" href="#signup"
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="home-tab">
                ...
                <p class="signin_link">Don't have an Account ?
                  <a id="profile-tab" data-bs-toggle="tab" data-bs-target="#signup" href="#signup" type="button"
              ...
              <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <p class="signin_link">Already have an Account ?
                  <a id="home-tab" data-bs-toggle="tab" data-bs-target="#signin" href="#signin" type="button" role="tab"
    ...
    <nav class="navbar sticky-top navbar-expand-sm d-none d-sm-block shadow py-2 justify-content-center"
    ...
    <div style="max-width: 1300px; margin: 0 auto; padding: 10px; background-color: white;">
      <div class="container">
        ...
        <div class="row justify-content-start mt-3">
          <div class="col-4">
            <input type="text" placeholder="Enter your name list">
          </div>
        </div>
